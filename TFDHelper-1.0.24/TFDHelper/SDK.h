...
namespace TFD
{
	...
	public:
		...
		uint8 Pad_UGameInstance_Class[0xB8]; // 0x48
	...
	{
	public:
		uint8 Pad_ViewportConsole[0x8]; // 0x0038(0x0008)
	...
	{
	public:
		uint8 Pad_ADebugCameraController[0x60];                                     // 0x0868(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
#pragma pack(pop)
	...
	public:
		...
		uint8 Pad_BoneArray[0x58]; // 0x58 <-- In Dumped SDK the class starts at 0x4B0 but the first field is listed as starting at 0x4A8? 
	...
	public:
		...
		uint8 CurrentInputMethod;                      // 0x0058(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8 InputControlMode;                        // 0x0059(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8 Pad_5A[0x76];                            // 0x005A(0x0076)(Fixing Size After Last Property [ Dumper-7 ])
		bool bBlockUpdateCursors;                      // 0x00D0(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		bool bBlockNavigationStart;                    // 0x00D1(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		EM1MouseVisibilityFlag MouseVisibilityFlag;    // 0x00D2(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8 MouseCursorStateFlag;                    // 0x00D3(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	{
	public:
		__int64 CharacterUniqueId;
		FM1TemplateId CharacterTid;
		FString Name;
		__int64 CombatPower;
	...
	{
	public:
		TArray<UM1PrivateOnlineSubService*> SubServices;			// 0xC8
		uint8 Pad_UM1PrivateOnlineServiceComponent_Class[0x8C8];	// 0xD8
		TWeakObjectPtr<class UM1Account> CachedAccount; // 0x1F8
	...
	{
	public:
		uint8 PadHeartbeat[0x208]; //0x910
	...
	public:
		...
		uint8 Pad_CharacterAttribute[0x12]; // 0x870
	...
	public:
		...
		class FString PlayerName; // 0xFB8
...
#pragma pack(pop)
	...
	public:
		...
		uint8 Pad_WeaponLevel[0x78]; // 0x368
	...
	public:
		...
		uint8                                         Pad_250[0x18];// 0x0250(0x0018)
...
#pragma pack(pop)
	...
	{
	public:
		uint8 Pad_MiniGameDifficulty[0x8];
	...
	{
	public:
		bool bAttachStart;                        // 0x04A8(0x0001)
		bool bAttachEnd;                          // 0x04A9(0x0001)
		uint8 Pad_4AA[0x30];                      // 0x04AA–0x04DA
		FVector EndLocation;                      // 0x04E0(0x000C)
		float CableLength;                        // 0x04EC(0x0004)
		int32 NumSegments;                        // 0x04F0(0x0004)
		float SubstepTime;                        // 0x04F4(0x0004)
		int32 SolverIterations;                   // 0x04F8(0x0004)
		bool bEnableStiffness;                    // 0x04FC(0x0001)
		bool bUseSubstepping;                     // 0x04FD(0x0001)
		bool bSkipCableUpdateWhenNotVisible;      // 0x04FE(0x0001)
		bool bSkipCableUpdateWhenNotOwnerRecentlyRendered; // 0x04FF(0x0001)
		bool bEnableCollision;                    // 0x0500(0x0001)
		uint8 Pad_501[0x3];                       // 0x0501(0x0003)
		float CollisionFriction;                  // 0x0504(0x0004)
		FVector CableForce;                       // 0x0508(0x000C)
		float CableGravityScale;                  // 0x0514(0x0004)
		float CableWidth;                         // 0x0518(0x0004)
		int32 NumSides;                           // 0x051C(0x0004)
		float TileMaterial;                       // 0x0520(0x0004)
		uint8 Pad_524[0x1C];                      // 0x0524(0x001C)
	...
	public:
		...
		uint8                                         Pad_340[0x8];          // 0x0340(0x0008)
		class UCableComponent* CableComponent;                               // 0x0348(0x0008)
		class AM1WireCaster* WireCaster;									 // 0x0350(0x0008)
		uint8                                         Pad_358[0x88];         // 0x0358(0x0088)
		class USkeletalMesh* DefaultMeshAsset;								 // 0x03E0(0x0008)
		uint8                                         Pad_3E8[0x78];         // 0x03E8(0x0078)
	public:
		static class UClass* StaticClass()
		{
	...
	public:
		//void AddTaggedBoolVariant(const struct FGameplayTag& Tag, class FName VariantName, bool Value);
		//void AddTaggedFloatVariant(const struct FGameplayTag& Tag, class FName VariantName, float Value);
		//void AddTaggedIntVariant(const struct FGameplayTag& Tag, class FName VariantName, int32 Value);
		//void AddTaggedNameVariant(const struct FGameplayTag& Tag, class FName VariantName, class FName Value);
		//void AddTaggedRotatorVariant(const struct FGameplayTag& Tag, class FName VariantName, const struct FRotator& Value);
		//void AddTaggedTransformVariant(const struct FGameplayTag& Tag, class FName VariantName, const struct FTransform& Value);
		//void AddTaggedVectorVariant(const struct FGameplayTag& Tag, class FName VariantName, const struct FVector& Value);
		//void BP_CancelAbility();
		//void BP_EndAbility();
		//void BP_OnActivated();
		//void BP_OnDeactivated(bool bCancelled);
		//TArray<struct FM1ActiveAbilityOperationId> BP_StartOperationsToSelfByTag(const struct FGameplayTagContainer& InTags, const struct FM1AbilityOperationParam& OpParam);
		//void EndAllOperationsFromSelf();
		//void EndOperationFromSelf(const struct FM1ActiveAbilityOperationId& ActiveOperationId);
		//void EndOperationsFromSelf(const TArray<struct FM1ActiveAbilityOperationId>& ActiveOperationIds);
		//void EndOperationsFromSelfByTag(const struct FGameplayTagContainer& InTags);
		//void IncrementTaggedIntVariant(const struct FGameplayTag& Tag, class FName VariantName);
		//void NetMulticastActivateAbility(const struct FM1AbilityContextHandle& InHandle);
		//void NetMulticastDeactivateAbility(bool InbCanceled);
		//void RemoveTaggedVariant(const struct FGameplayTag& Tag, class FName VariantName);
		//void ServerDeferredApplyTask();
		//void ServerRequestCancelAbility();
		//void SetContextTargetInfo(const struct FM1AbilityTargetInfoHandle& TargetInfoHandle);

		bool BP_IsNetAuthority() const;
		//void BP_MakePreloadAssetList(struct FM1AbilityAssetPreload* OutAbilityAssetPreload) const;
		//class UM1AbilityComponent* GetAbilityComponent() const;
		//const struct FM1AbilityContextHandle GetAbilityContextHandle() const;
		//const struct FM1AbilityData GetAbilityData() const;
		//struct FM1AbilityId GetAbilityId() const;
		class AActor* GetAbilityInstigator() const;
		//struct FM1AbilityTargetInfoHandle GetAbilityTargetInfo() const;
		...
		//const struct FM1AbilityOwnerInfo GetOwnerInfo() const;
		class APlayerController* GetOwnerPlayerController() const;
		//class UM1QueryServiceComponent* GetQueryServiceComponent() const;
		float GetVelocityAndRangeMultiplier() const;
		//bool HasTraitTag(const struct FGameplayTag& InTraitTag) const;
		//bool IsActive() const;
		//bool IsAutonomous() const;
		//bool IsLocallyControlled() const;
		//bool IsRemoteAutonomous() const;
	...
	{
	public:
		uint8 Pad_2A8[0x98];                          // 0x02A8(0x0098) // Combined: Pad_2A8 + Pad_2D0
	public:
		//void BP_Initialize();
		//void BP_OnCooltimeEnded();
		//void BP_PreServerSpawnProjectileFromLocal(const struct FGameplayTagContainer& InTags, struct FGameplayTagContainer* OutFwardingOperationTags, TArray<class FName>* OutForwardingParamNames, TArray<struct FM1TaggedAbilityParamData>* OutTaggedParams, TArray<struct FM1AbilityParamData>* OutParams);
	...
	public:
		...
		//void OnOwnerMovementModeChanged(class ACharacter* Character, EMovementMode PrevMovementMode, uint8 PrevCustomMode);
